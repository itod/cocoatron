...
#import "CocoatronParamsTableAction.h"
...
@implementation CocoatronParamsTableAction
...
- (void)writeToDictionary:(NSMutableDictionary *)dict;
{
	...
	if (![self paramsAreEmpty]) {
		...
		[dict setObject:paramsOrder forKey:KeyXSLTParamsOrder];
	}
}
